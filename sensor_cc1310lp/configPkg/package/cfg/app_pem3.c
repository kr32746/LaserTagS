 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/Kevin/workspace_v7/sensor_cc1310lp/sensor_cc1310lp/configPkg/package/cfg/app_pem3");
...
xdc_Ptr xdc_runtime_HeapMin_Object__get__S(xdc_Ptr oa, xdc_Int i)
{
    ...
    /* the bogus 'const' in the cast suppresses Klocwork MISRA complaints */
    return ((xdc_runtime_HeapMin_Object__ * const)xdc_runtime_HeapMin_Object__table__C) + i;
}
    ...
    xdc_runtime_Error_Block *__eb)
{
    ...
    /* common instance initialization */
    __obj = xdc_runtime_Core_createObject__I(&xdc_runtime_HeapMin_Object__DESC__C, NULL, &__prms, (xdc_CPtr)__paramsPtr, 0, __eb);
    if (__obj == NULL) {
        return NULL;
    }
